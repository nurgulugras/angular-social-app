...
namespace ServerApp.Controllers
{
    ...
    public class UsersController:ControllerBase
    {
        ...
        public async Task<IActionResult> GetUsers([FromQuery]UserQueryParams userParams)
        {
            ...
            var result =_mapper.Map<IEnumerable<UserForDetailsDTO>>(users);
            return Ok(result);
        }
        //api/users/5
        [HttpGet("{id}")]
        ...
        public async Task<IActionResult>UpdateUser(int id,UserForUpdateDTO model)
        {
            ...
            return Ok();
            throw new System.Exception("guncelleme sirasinda hata olustu");
        }
        //users/1/follow/2
        ...
        public async Task<IActionResult> FollowUser(int followerUserId,int userId)
        {
             ...
             return BadRequest("Zaten kullaniciyi takip ediyorsunuz.");
